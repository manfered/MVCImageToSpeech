(function () {
    ...
    ///
    ///
    //image to speech related codes
    ///
    ///
    //changing the aduio source for each upload
    function AudioPlayerChange(dirName , audioName) {
        var audio = $("#player");
        audio.attr("src", dirName + "/" + audioName);
        /****************/
        audio[0].pause();
            ...
            $('#form0').ajaxSubmit({
                ...
                complete: function (xhr) {
                    ...
                    if (obj.status == "Success") {
                        ...
                        //changing the audio source in order to play audio file
                        AudioPlayerChange(obj.audioDirectory, obj.audioFileName);
